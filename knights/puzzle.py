...
# Puzzle 2
# A says "We are the same kind." = (AKnight AND BKnight) OR (AKnave AND BKnave) 
# B says "We are of different kinds." = (Aknight AND BKnave) OR (AKnave AND BKnight)
knowledge2 = And(
    Or(AKnight, AKnave), Or(BKnight, BKnave),
    Not(And(AKnight, AKnave)), Not(And(BKnight, BKnave)),
...
knowledge3 = And(
    ...
    # A says: AKnight OR says AKnave
    Implication(AKnight, Or(AKnight, AKnave)),
    Implication(AKnave, Not(Or(AKnight, AKnave))),
    # B says: A says AKnave
    # if B is a knight, then A said he is a knave
    #       if A is a knight, then he is a knave
    #       if A is a knave, then he is not a knave
    # if B is a knave, then A said he is a knight
    #       if A is a knight, then he is a knight
